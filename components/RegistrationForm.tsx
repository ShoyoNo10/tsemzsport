...
//                   </p>
//                   <p>
//                     ✅ Насанд хүрэгчид /эмэгтэй/: Мягмар 19:00, Бямба 15:00
//                   </p>
//                 </div>
//               </div>
...
//               </p>
//               <p className="mt-2">
//                 Суралцагч нь өөрийн үнэн зөв мэдээллийг бүртгэлийн формд
//                 оруулна. Буруу мэдээлэл оруулснаас үүсэх асуудлыг бүртгүүлэгч
//                 өөрөө хариуцна.
//               </p>
...
//               </p>
//               <p className="mt-2">
//                 Сонгосон анги, сар, салбарын төлбөрийг төлснөөр бүртгэл
//                 баталгаажна. Төлбөр төлөгдөөгүй бүртгэлийг баталгаажсан гэж
//                 үзэхгүй.
//               </p>

//               <p className="mt-5 font-bold text-slate-900">
//                 3. Хичээлийн ирц, хариуцлага
//               </p>
//               <p className="mt-2">
//                 Суралцагч нь сонгосон хуваарийн дагуу хичээлдээ тогтмол
//                 хамрагдана. Хүндэтгэх шалтгаангүйгээр тасалсан хичээлийг нөхөн
//                 оруулах эсэхийг сургалтын байгууллагын дотоод журмаар
//                 шийдвэрлэнэ.
//               </p>

//               <p className="mt-5 font-bold text-slate-900">
//                 4. Эрүүл мэнд, аюулгүй байдал
//               </p>
//               <p className="mt-2">
//                 Суралцагч нь бэлтгэл хийхэд эрүүл мэндийн хувьд боломжтой байх
//                 шаардлагатай. Бэлтгэлийн үеэр багшийн зааврыг дагаж, спортын
//                 аюулгүй байдлыг мөрдөнө.
//               </p>
...
//               </p>
//               <p className="mt-2">
//                 Салбар, анги, сарын сонголттой холбоотой өөрчлөлтийг
//                 байгууллагатай холбогдож шийдвэрлэнэ. Бүртгэл болон төлбөртэй
//                 холбоотой асуудлыг байгууллагын нөхцөл, журмын дагуу
//                 шийдвэрлэнэ.
//               </p>
...
//               </p>
//               <p className="mt-2">
//                 Бүртгүүлэгч нь дээрх нөхцөлүүдийг уншиж танилцсан бөгөөд
//                 зөвшөөрсөн тохиолдолд төлбөр төлөх үйлдлийг үргэлжлүүлнэ.
//               </p>
//             </div>
            ...
            <div className="mt-4 space-y-4 text-sm text-slate-200">
              <div className="rounded-2xl bg-white/10 p-4">
                ...
                <div className="mt-3 space-y-1">
                  ...
                  <p>✅ Насанд хүрэгчид /эмэгтэй/: Лхагва 19:00 Бямба 15:00</p>
                </div>
              </div>
