...
export default function RegistrationForm() {
  ...
  const isSelectedClassAvailable = useMemo(() => {
    if (!selectedClass) {
      return false;
    }

    return !selectedClass.isFull;
  }, [selectedClass]);
    ...
    <div className="mx-auto grid max-w-6xl gap-6 lg:grid-cols-[1.2fr_0.8fr]">
      <div className="rounded-[28px] border border-white/10 bg-white/95 p-5 shadow-[0_20px_80px_rgba(0,0,0,0.25)] backdrop-blur-xl sm:p-8">
        <div className="mb-6">
          ...
          <p className="mt-2 text-sm text-slate-500">
            Мэдээллээ зөв бөглөж, суудалтай ангийг сонгоно уу.
          </p>
        </div>
          ...
          <div className="sm:col-span-2">
            {selectedClass && selectedBranch && selectedSchedule ? (
                  ...
                  <div className="rounded-2xl bg-white p-4 md:col-span-2">
                    ...
                    <div className="mt-2 flex flex-wrap gap-3">
                      <span className="rounded-full bg-slate-100 px-3 py-1 text-sm font-medium text-slate-700">
                        Нийт суудал: {selectedClass.capacity}
                      </span>
                      <span className="rounded-full bg-emerald-100 px-3 py-1 text-sm font-medium text-emerald-700">
                        Үлдсэн: {selectedClass.remainingSeats}
                      </span>
                      <span
                      ...
                      >
                        {selectedClass.isFull ? "Анги дүүрсэн" : "Бүртгэл нээлттэй"}
                      </span>
                    </div>
                  </div>
                </div>
              ...
              <div className="rounded-[24px] border border-dashed border-slate-300 bg-slate-50 p-5">
                ...
                <p className="mt-2 text-sm text-slate-500">
                  Анги сонгосны дараа үнэ, салбар, хуваарь, суудлын мэдээлэл энд гарч ирнэ.
                </p>
              </div>
            )}
          </div>
        ...
        {selectedClass?.isFull ? (
          <div className="mt-5 rounded-2xl border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-700">
            Энэ анги дүүрсэн тул бүртгүүлэх боломжгүй.
          </div>
        ) : null}
      ...
      <div className="space-y-6">
        <div className="rounded-[28px] border border-white/10 bg-white/10 p-6 text-white shadow-[0_20px_80px_rgba(0,0,0,0.25)] backdrop-blur-xl">
          ...
          <div className="mt-4 space-y-3 text-sm text-slate-200">
            ...
            <div className="rounded-2xl bg-white/10 p-4">
              ✅ Суудлын үлдэгдэл шууд харагдана
            </div>
          </div>
        </div>
      </div>
