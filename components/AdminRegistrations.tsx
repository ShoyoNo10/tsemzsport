...
//                 <th className="px-3 py-2 text-black">Овог нэр</th>
//                 <th className="px-3 py-2 text-black">Регистр</th>
//                 <th className="px-3 py-2 text-black">Нас</th>
//                 <th className="px-3 py-2 text-black">Хүйс</th>
//                 <th className="px-3 py-2 text-black">Утас</th>
//                 <th className="px-3 py-2 text-black">Статус</th>
//                 <th className="px-3 py-2 text-black">Төлбөр</th>
//                 <th className="px-3 py-2 text-black">Үйлдэл</th>
...
//                   </td>
//                   <td className="px-3 py-2 text-black">{item.registerNumber}</td>
//                   <td className="px-3 py-2 text-black">{item.age ?? "-"}</td>
//                   <td className="px-3 py-2 text-black">
...
//             <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
//               <InfoItem label="ID" value={selectedRegistration._id} />
//               <InfoItem label="Овог" value={selectedRegistration.lastName} />
//               <InfoItem label="Нэр" value={selectedRegistration.firstName} />
//               <InfoItem
//                 label="Регистр"
//                 value={selectedRegistration.registerNumber}
//               />
...
//                 label="Нас"
//                 value={
//                   selectedRegistration.age !== undefined
//                     ? String(selectedRegistration.age)
//                     : "-"
//                 }
//               />
//               <InfoItem
//                 label="Хүйс"
//                 value={getGenderLabel(selectedRegistration.gender)}
//               />
//               <InfoItem
//                 label="Үндсэн утас"
//                 value={selectedRegistration.phonePrimary}
...
//                 fullWidth
//               />
//               <InfoItem label="Статус" value={selectedRegistration.status} />
//               <InfoItem
//                 label="Төлбөрийн статус"
//                 value={selectedRegistration.paymentStatus}
//               />
...
export default function AdminRegistrations({
  ...
  return (
    <>
      ...
      <section className="rounded-2xl bg-white p-5 shadow print-hidden">
        <h2 className="text-xl font-semibold text-slate-900">Бүртгэлүүд</h2>
      ...
      {selectedRegistration && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4 print:bg-white">
          <div className="print-area max-h-[90vh] w-full max-w-3xl overflow-y-auto rounded-2xl bg-white p-6 shadow-2xl">
            <div className="mb-6 flex items-start justify-between gap-4 print:block">
              ...
              <button
                type="button"
                onClick={() => setSelectedRegistration(null)}
                className="print-hidden rounded-lg bg-slate-100 px-3 py-1.5 text-slate-700 hover:bg-slate-200"
              >
                Хаах
              </button>
            </div>

            <div className="print-grid grid grid-cols-1 gap-4 md:grid-cols-2">
              <InfoItem label="ID" value={selectedRegistration._id} />
              <InfoItem label="Овог" value={selectedRegistration.lastName} />
              <InfoItem label="Нэр" value={selectedRegistration.firstName} />
              <InfoItem
...
function InfoItem({
  ...
  return (
    <div
      className={`print-item rounded-xl border border-slate-200 bg-slate-50 p-4 ${
        fullWidth ? "md:col-span-2" : ""
      }`}
    >
      <p className="print-label text-xs font-semibold uppercase tracking-wide text-slate-500">
        {label}
      </p>
      <p className="print-value mt-2 break-words text-sm text-slate-900">
        {value || "-"}
      </p>
    </div>
  );
