...
export const productSizeVariantSchema = z.object({
  size: z.string().min(1, "Size шаардлагатай"),
  stock: z.number().int().min(0, "Stock буруу байна"),
});

export const createProductSchema = z.object({
  name: z.string().min(1, "Барааны нэр шаардлагатай"),
  slug: z.string().min(1, "Slug шаардлагатай"),
  description: z.string().min(1, "Тайлбар шаардлагатай"),
  price: z.number().min(0, "Үнэ буруу байна"),
  imageUrl: z.string().min(1, "Зураг шаардлагатай"),
  categoryId: z.string().min(1, "Ангилал сонгоно уу"),
  sizeVariants: z
    .array(productSizeVariantSchema)
    .min(1, "Дор хаяж 1 size оруулна уу"),
  isActive: z.boolean(),
});
